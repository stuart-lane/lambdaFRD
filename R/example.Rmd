...
This document shows an example usage of the `lambda_class` function to replicate
...
setwd("C:/Users/sl14120/OneDrive - University of Bristol/PostDoc/LocalFullerFRD/GITHUB")
```

and the new `lambda_class` function. (A full package is in development, but as an intermediate step, the easiest temporary usage of the function is probably to download the `lambda_class_function.R` file and save in the appropriate directory).
